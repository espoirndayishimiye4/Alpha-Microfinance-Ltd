...
<div class="container" style="background-color:#0B2752;color:#fff">
 <div class="row">
    <div class="col-md-6 mx-auto" style="border:2px">
        ...
        <div class="mb-4 mt-4">
            <label for="exampleInputEmail1" class="form-label">Enter PassCode sent To your Phone</label>
            <input type="number" name="username" class="form-control" placeholder="Ex: 321..." autocomplete="off" required>
          
        </div>
         <button style="background-color:#fff;color:#0B2752" type="submit" class="btn btn-primary">Reset Password</button> 
