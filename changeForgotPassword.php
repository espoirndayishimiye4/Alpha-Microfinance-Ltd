 ...
 <div class="row">
    <div class="col-md-6 mx-auto" style="border:2px">
        ...
        <div class="mb-4 mt-4">
            ...
            <input type="password" name="username" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" autocomplete="off" required>
          
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Comfirm New Password</label>
            <input type="password" name="password" class="form-control" id="exampleInputPassword1"required>
        </div>
        <div class="row">
        <button style="background-color:#fff;color:#0B2752" type="submit" class="btn btn-primary">Login</button> 
        </div>
      </form> 
        <br> 
    </div>
