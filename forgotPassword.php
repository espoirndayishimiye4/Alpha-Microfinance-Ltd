 ...
 <div class="row">
    <div class="col-md-6 mx-auto" style="border:2px">
        ...
        <div class="mb-4 mt-4">
            ...
            <input type="number" name="username" class="form-control" placeholder="Ex: 078..." autocomplete="off" required>
          
        </div>
        
      
         <button style="background-color:#fff;color:#0B2752" type="submit" class="btn btn-primary">Send SMS</button> 
